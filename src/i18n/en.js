...
const en = {
  ...
  'top.tripSummary': '{days} days · start {hour}:00',
  'top.tripOption': '{emoji} {title} · {days}d · {stops} stops',
  ...
  'plan.atStops': 'at the stops',
  'plan.onTheMove': 'on the move',
  'plan.dayUsed': 'of the day used',
