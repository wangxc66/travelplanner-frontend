...
const en = {
  ...
  'auth.usernamePlaceholder': '3–64 letters, numbers, dots, dashes, or underscores',
  'auth.usernameRules': 'Use 3–64 letters, numbers, dots, dashes, or underscores',
  'auth.displayName': 'Display name',
  'auth.displayNamePlaceholder': 'How should we greet you?',
  'auth.displayNameRules': 'Display name must be 100 characters or fewer',
  'auth.password': 'Password',
  'auth.passwordPlaceholder': 'At least 12 characters',
  'auth.passwordRules': 'Use at least 12 characters and no more than 72 UTF-8 bytes',
  'auth.footnote':
  ...
  'error.usernameRules': 'Use 3–64 letters, numbers, dots, dashes, or underscores',
  'error.passwordRules': 'Use at least 12 characters and no more than 72 UTF-8 bytes',
  'error.displayNameRules': 'Display name must be 100 characters or fewer',
