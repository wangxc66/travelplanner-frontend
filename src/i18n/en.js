...
const en = {
  ...
  'plan.reorderHint': 'Turn on to drag stops around — off, a click just shows the stop on the map',
  'plan.reorderDone': 'Done',
  'plan.reorderOffHint': 'Stop reordering',
  ...
  'assistant.subtitle': 'Ask about your itinerary, or ask for a change — you confirm before anything is applied.',
  ...
  'assistant.confirmTitle': 'Apply this change?',
  'assistant.confirm': 'Apply',
  'assistant.cancel': 'Cancel',
  'assistant.retry': 'Try again',
  'assistant.reset': 'Start over',
  'assistant.cancelled': 'That change was cancelled — nothing was applied.',
  'assistant.loopLimit': 'That needs more steps than I can take at once. Try asking for a smaller piece of it.',
  'assistant.missingTrip': 'Open a trip first and I can work on it.',
  'assistant.thisPlace': 'this place',
  'assistant.tool.add_stop': 'Add {place} to day {dayIndex}',
  'assistant.tool.remove_stop': 'Remove {place} from the trip',
  'assistant.tool.move_stop': 'Move {place} to day {dayIndex}',
  'assistant.tool.optimize_day': 'Reorder day {dayIndex} for the shortest route',
