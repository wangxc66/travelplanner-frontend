...
const zh = {
  ...
  'auth.continue': '进入',
  'auth.username': '用户名',
  'auth.usernamePlaceholder': '3–64 位字母、数字、点、横线或下划线',
  'auth.usernameRules': '用户名需为 3–64 位，只能包含字母、数字、点、横线或下划线',
  'auth.displayName': '显示名称',
  'auth.displayNamePlaceholder': '希望我们怎么称呼你？',
  'auth.displayNameRules': '显示名称不能超过 100 个字符',
  'auth.password': '密码',
  'auth.passwordPlaceholder': '至少 12 个字符',
  'auth.passwordRules': '密码至少 12 个字符，且不能超过 72 个 UTF-8 字节',
  'auth.footnote':
  ...
  // 顶栏
  'top.newTrip': '新建行程',
  'top.tripSummary': '{days} 天 · {stops} 个点 · {hour}:00 出发',
  'top.tripOption': '{days} 天 · {stops} 个点',

  // 行程设置
  'settings.title': '行程设置',
  'settings.switch': '切换行程',
  ...
  'explore.addToDay': '加入',
  'explore.addToDayHint': '加入第 {day} 天',
  ...
  'plan.reorder': '调整顺序',
  'plan.reorderHint': '打开后可以拖动调整顺序；关着的时候点一下只是在地图上定位',
  'plan.reorderDone': '完成',
  'plan.reorderOffHint': '结束调整',
  'plan.emptyDay': '第 {day} 天还是空的。',
  'plan.emptyDayHint': '去「探索」标签搜索，把景点加进第 {day} 天。',
  ...
  'error.usernameRules': '用户名需为 3–64 位，只能包含字母、数字、点、横线或下划线',
  'error.passwordRules': '密码至少 12 个字符，且不能超过 72 个 UTF-8 字节',
  'error.displayNameRules': '显示名称不能超过 100 个字符',
