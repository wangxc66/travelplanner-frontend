...
const zh = {
  ...
  'assistant.subtitle': '可以询问行程，也可以让我改 —— 每次改动都会先问过你。',
  ...
  'assistant.confirmTitle': '要执行这个操作吗？',
  'assistant.confirm': '执行',
  'assistant.cancel': '取消',
  'assistant.retry': '重试',
  'assistant.reset': '重新开始',
  'assistant.cancelled': '已取消，行程没有任何改动。',
  'assistant.loopLimit': '这件事需要的步骤太多，我先停在这里。把需求拆小一点再试试。',
  'assistant.missingTrip': '先打开一个行程，我才能动手。',
  'assistant.thisPlace': '这个地点',
  'assistant.tool.add_stop': '把{place}加到第 {dayIndex} 天',
  'assistant.tool.remove_stop': '把{place}从行程里移除',
  'assistant.tool.move_stop': '把{place}移到第 {dayIndex} 天',
  'assistant.tool.optimize_day': '重排第 {dayIndex} 天，走最短的路线',
